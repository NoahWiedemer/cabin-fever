...
- **Money**: every kill by anyone in the fireteam pays every member the same amount (mauler $60, dog $70, biter $75, striker $80, charger $90, crusher $400, stalker $400, +$20 for a headshot), plus a round-clear bonus of $250 + $50 × round. Everyone starts with $500 and spends from an own wallet; bots buy rifle damage upgrades.
- **Store arsenal**
...
The L4D2, Titanfall 2, SPAS-12 and Meshy models were supplied by the owner, the Stalker model by a collaborator. They are fine for a private project, but check their licences before publishing the game.
